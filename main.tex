...
It is a constructive logic, with the property that classical logic is conservative
for the fragment. For this reason one expects Skolem's Theorem to hold
for coherent logic. Moreover, one would expect a simpler proof transformation,
with the transformed proofs constructive. We shall see that this indeed works out.
...
section we give some lemma's used in the sequel, and we prove the
...
\section{Addition of equality}\label{sec:withoutequality}
