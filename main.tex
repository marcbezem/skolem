...
Part 2 of the lemma above immediately yields Skolem's Theorem.
\begin{corollary}\label{thm:skolemwith=}
If $\Gamma\vdash_{\vec{x}}^{T_{I\!f{+}}} A$ and $\Gamma,A$ does not mention $f$,
