...
The failure of Skolem's Theorem 
for constructive logic can be remediated by requiring in (\ref{allexist})
unique existence instead of existence, see \cite{xxx}.
